...
function Datepicker() {
	...
	this.regional[""] = { // Default regional settings
		...
		nextText: "Ileri", // Display text for next month link
		...
		monthNamesShort: ["Ocak", "Şubat", "Mart", "Nisan", "Mayıs", "Haziran",
			"Temmuz", "Ağustos", "Eylül", "Ekim", "Kasım", "Aralık"], // For formatting
		dayNames: ["Pazartesi", "Salı", "Çarşanba", "Perşembe", "Cuma", "Cumartesi", "Pazar"], // For formatting
		dayNamesShort: ["Ptesi", "Salı", "Çar", "Per", "Cuma", "Ctesi", "Pazar"], // For formatting
